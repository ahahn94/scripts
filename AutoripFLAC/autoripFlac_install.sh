...
echo "ou can refer to https://www.howtogeek.com/117709/how-to-change-your-default-applications-on-ubuntu-4-ways/ if you need help setting up the default application. Have a look at the point Removable Media."
